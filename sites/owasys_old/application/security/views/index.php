...
/**
 * OWASYS security view-model.
 * Data only: security strategy is declared through explicit contracts.
 */
return [
    'title' => 'Security',
    'badge' => 'Profiles',
    ...
    'cards' => [
        [
            ...
            'items' => [
                'admin: registry, blueprint, generation, validation and export rights',
                'dev: draft, structure, data, workflow, security draft and validation rights',
            ],
        ],
        [
            ...
            'items' => [
                ...
                'audit_strategy: mandatory_for_write_actions',
            ],
        ],
    ],
    'contracts' => [
        'OWASYS_SECURITY_POLICY_V1',
        'OPUS_PROFILE_REGISTRY_V1',
    ],
    'actions' => [
        'Assign profile',
        'Configure permissions',
        'Review audit strategy',
        'Prepare SSO strategy as separate configuration',
    ],
];
