...
$files = [
    ...
    'application/security/services/SecurityContext.php',
    'application/security/services/SecurityRuntimeCoordinatorInterface.php',
    'application/security/services/SecurityRuntimeCoordinator.php',
