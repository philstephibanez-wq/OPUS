 ...
 *
 * Contract:
 *   Verify that the official ASAP RefBook documentation assets added by this
...
foreach ($examples as $id) {
    ...
    if (!str_contains($content, 'ASAP RefBook example:')) {
...
echo 'P113D3B_ASAP_REFBOOK_DOC_ASSETS_STATIC_SMOKE_OK' . PHP_EOL;
