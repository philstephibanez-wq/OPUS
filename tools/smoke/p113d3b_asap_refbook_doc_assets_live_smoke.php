 ...
 *
 * Contract:
 *   Ask ASAP_REF_BOOK live API to recompute asset integrity after the ASAP
 *   documentation assets are installed.
 */

$url = 'http://127.0.0.1/ASAP_REF_BOOK/api/refbook/asset-integrity';
...
echo 'P113D3B_ASAP_REFBOOK_DOC_ASSETS_LIVE_SMOKE_OK' . PHP_EOL;
