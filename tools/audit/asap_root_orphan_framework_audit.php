...
$outDir = $reportRoot . DIRECTORY_SEPARATOR . 'asap_root_orphan_framework_audit_' . $stamp;
...
$rootFilePlan = [
    'Acl.php' => ['PUBLIC_FACADE_REVIEW', 'Acl/Acl.php', 'ASAP\\Acl\\Acl', 'Root facade candidate. Review against the Acl domain before moving.'],
    'Bootstrap.php' => ['CORE_REVIEW', 'Core/Bootstrap.php', 'ASAP\\Core\\Bootstrap', 'Core bootstrap candidate.'],
    'ConfigLoader.php' => ['CONFIG_REVIEW', 'Config/ConfigLoader.php', 'ASAP\\Config\\ConfigLoader', 'Configuration loader candidate.'],
    'Configuration.php' => ['CONFIG_REVIEW', 'Config/Configuration.php', 'ASAP\\Config\\Configuration', 'Configuration object candidate.'],
    'Debug.php' => ['DEBUG_REVIEW', 'Debug/Debug.php', 'ASAP\\Debug\\Debug', 'Debug domain candidate.'],
    'Exception.php' => ['EXCEPTION_REVIEW', 'Exception/Exception.php', 'ASAP\\Exception\\Exception', 'Base exception candidate.'],
    'Fsm.php' => ['PUBLIC_FACADE_REVIEW', 'Fsm/Fsm.php', 'ASAP\\Fsm\\Fsm', 'Root facade candidate. Review against the Fsm domain before moving.'],
    'Kernel.php' => ['CORE_REVIEW', 'Core/Kernel.php', 'ASAP\\Core\\Kernel', 'Core kernel candidate.'],
    'Package.php' => ['PACKAGE_REVIEW', 'Package/Package.php', 'ASAP\\Package\\Package', 'Package domain candidate.'],
    'PackageRepository.php' => ['PACKAGE_REVIEW', 'Package/PackageRepository.php', 'ASAP\\Package\\PackageRepository', 'Package repository candidate.'],
    'Response.php' => ['PUBLIC_FACADE_REVIEW', 'Response/ResponseFacade.php', 'ASAP\\Response\\ResponseFacade', 'Root response facade candidate. Must be reconciled with ASAP\\Response\\Response.'],
    'SimpleXMLElementExtended.class.php' => ['LEGACY_COMPAT_REVIEW', 'Compatibility/LegacySimpleXMLElementExtended.php', 'ASAP\\Compatibility\\LegacySimpleXMLElementExtended', 'Legacy .class.php file. Prefer removal or explicit compatibility domain.'],
    'SimpleXMLElementExtended.php' => ['COMPATIBILITY_REVIEW', 'Compatibility/SimpleXMLElementExtended.php', 'ASAP\\Compatibility\\SimpleXMLElementExtended', 'Compatibility helper candidate.'],
    'Singleton.class.php' => ['LEGACY_COMPAT_REVIEW', 'Compatibility/LegacySingleton.php', 'ASAP\\Compatibility\\LegacySingleton', 'Legacy .class.php file. Prefer removal or explicit compatibility domain.'],
    'Singleton.php' => ['COMPATIBILITY_REVIEW', 'Compatibility/Singleton.php', 'ASAP\\Compatibility\\Singleton', 'Compatibility helper candidate.'],
    'Support.php' => ['SUPPORT_REVIEW', 'Support/Support.php', 'ASAP\\Support\\Support', 'Support domain candidate.'],
    'Validator.php' => ['VALIDATION_REVIEW', 'Validation/Validator.php', 'ASAP\\Validation\\Validator', 'Validation domain candidate.'],
    'View.php' => ['PUBLIC_FACADE_REVIEW', 'View/View.php', 'ASAP\\View\\View', 'Root facade candidate. Must be reconciled with ASAP\\View\\Html.'],
];
...
function shouldSkipSearchPath(string $path): bool
{
    ...
    return str_contains($normalized, '/.git/')
        ...
        || str_contains(strtolower($normalized), '/tools/audit/asap_root_orphan_framework_audit.php')
...
$md = [];
$md[] = '# P112Q2F — ASAP Root and Orphan Framework Audit';
$md[] = '';
...
file_put_contents($outDir . DIRECTORY_SEPARATOR . 'asap_root_orphan_framework_audit.md', implode(PHP_EOL, $md) . PHP_EOL);
