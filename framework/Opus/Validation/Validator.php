 ...
 * OPUS_REFBOOK:
 *   domain: VALIDATION
 *   role: Class Validator belongs to the VALIDATION Opus framework domain.
 *   contract:
 ...
 *
 * Role:
 *   Preserve the original Opus validator domain with explicit PHP 8 methods.
 *
 * Responsibility:
...
final class Validator
{
     ...
     * old Opus code that created `new OPUS_Validator()`.
     */
