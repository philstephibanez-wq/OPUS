 ...
 * OPUS_REFBOOK:
 *   domain: LSTSA
 *   role: Class LstsaReportCatalog belongs to the LSTSA Opus framework domain.
 *   contract:
...
final class LstsaReportCatalog
{
    ...
    public function __construct(string $projectRoot)
    {
        ...
        if ($root === '' || !is_dir($root)) {
            throw new \RuntimeException('Invalid Opus project root for Lstsa catalog: ' . $projectRoot);
        }
    ...
    public function build(int $limit = 50): array
    {
        ...
        return [
            'schema' => 'OPUS_Lstsa_REPORT_CATALOG_V1',
