 ...
 *
 * Role:
 *   Bridge the native OPUS HTTP entrypoint to the first administrator dashboard
 *   route without bypassing the admin route control plane.
 *
 * Responsibility:
 ...
 *
 * Contract:
 *   Only the loopback-local admin preview may receive the native admin dashboard
 *   scope until OPUS Identity Authority replaces this bootstrap identity. Every
 *   non-local or malformed admin route request is denied through the admin
 *   control plane and rendered as the opaque public support response.
 */
